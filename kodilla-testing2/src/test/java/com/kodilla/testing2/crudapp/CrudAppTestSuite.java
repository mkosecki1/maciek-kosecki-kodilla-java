...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://mkosecki1.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException{
        ...
        driverTrello.findElement(By.id("user")).sendKeys("mkosecki@op.pl");
        driverTrello.findElement(By.id("password")).sendKeys("MaciekTrello82");
    ...
    private void deleteTestTaskCrud(String taskName)throws InterruptedException{
